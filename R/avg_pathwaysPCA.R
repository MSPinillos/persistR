#' @title Average pathways of post-disturbance dynamics (PCA)
#'
#' @description The function \code{avg.pathwaysPCA} summarizes and represents average
...
avg.pathwaysPCA <- function(abundance, sites, surveys, cluster, type = "mixed",
                            onlyPaths = NULL, lwd.factor = NULL,
                            axes = c(1, 2), species = FALSE, sp.fac = 1,
