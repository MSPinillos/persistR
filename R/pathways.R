#' @title Individual pathways of post-disturbance dynamics
#'
#' @description The function \code{pathways} represents post-disturbance dynamics of a set
...
#'
#' @seealso \code{\link{avg.pathways}}
#'
#' @examples
#'
...
pathways <- function(abundance, sites, surveys, type = "mixed", onlyDraw = NULL,
                     cluster = NULL, axes = c(1, 2), species = FALSE, zoom = FALSE,
